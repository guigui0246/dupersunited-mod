...
public final class ClickSlotCommand {
    ...
    public static LiteralArgumentBuilder<FabricClientCommandSource> register() {
        return literal("click-slot")
                .executes(c -> {
                    CommandCat.sendMessage(Text.literal("Usage: /du click-slot <slot> <count> <delayMs>").formatted(Formatting.RED), true);
                    return 1;
                })
                        ...
                        .then(argument("count", IntegerArgumentType.integer(1, 10000))
                                .then(argument("delayMs", IntegerArgumentType.integer(0, 10000))
                                        .executes(c -> {
                                            ...
                                            CommandCat.sendMessage(Text.literal("Clicking slot ")
