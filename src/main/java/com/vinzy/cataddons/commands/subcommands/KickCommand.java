        ...
        return literal("kick")
            ...
            .then(literal("pos")
                .executes(c -> {
                    ...
                    CommandCat.sendMessage(Text.literal("Sending invalid position packet...").formatted(Formatting.WHITE), true);
                    return 1;
                })
            )
            .then(literal("hurt")
                .executes(c -> {
                    ...
                    CommandCat.sendMessage(Text.literal("Sending invalid health packet...").formatted(Formatting.WHITE), true);
                    return 1;
                })
            )
            .then(literal("chat")
                .executes(c -> {
                    ...
                    CommandCat.sendMessage(Text.literal("Sending malformed chat packet...").formatted(Formatting.WHITE), true);
                    return 1;
                })
            )
            .then(literal("crash")
