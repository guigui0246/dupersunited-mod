...
import com.vinzy.cataddons.modules.glitcha.PayAllSettingsModule;
...
public class PayAllManager {
    ...
    public static void startPayAll() {
        ...
        try {
            ...
            CommandCat.sendMessage(Text.literal("Invalid amount: ").formatted(Formatting.WHITE)
        ...
        CommandCat.sendMessage(Text.literal("Added ")
    ...
    public static void onTick() {
        ...
        CommandCat.sendMessage(Text.literal("Sent ")
