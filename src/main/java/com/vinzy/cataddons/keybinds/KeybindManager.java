...
import com.vinzy.cataddons.features.screens.*;
import com.vinzy.cataddons.features.screens.macroscreen.*;
    ...
    public static void registerTickHandler() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            for (Map.Entry<KeyBinding, KeybindAction> entry : keybinds.entrySet()) {
                int glfwKey = ((KeyBindingAccessor) entry.getKey()).cataddons$getBoundKey().getCode();
