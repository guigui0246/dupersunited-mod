...
public class PropagandaModule extends Module {
    private static final List<AdData> AD_REGISTRY = List.of(
        new AdData(Identifier.of("cataddons", "textures/ads/dupes.png"),"https://discord.gg/dupes"),
        new AdData(Identifier.of("cataddons", "textures/ads/loko.png"),"https://instagram.com/fakefourloko"),
        new AdData(Identifier.of("cataddons", "textures/ads/propaganda.png"),"https://discord.gg/palantir"),
        new AdData(Identifier.of("cataddons", "textures/ads/larps.png"),"https://glitcha.wtf"),
        new AdData(Identifier.of("cataddons", "textures/ads/please-feed-crosby.png"), "https://github.com/sponsors/crosby-moe")
    );
